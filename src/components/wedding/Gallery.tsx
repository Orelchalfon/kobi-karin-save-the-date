...
import img6 from "@/assets/gallery-6.jpeg.asset.json";
import img7 from "@/assets/gallery-7.jpeg.asset.json";
import img8 from "@/assets/gallery-8.jpeg.asset.json";

const images = [
  { src: img4.url, alt: "קובי וקארין · Save the date" },
  { src: img6.url, alt: "קובי וקארין · על הרציף" },
  { src: img5.url, alt: "קובי וקארין · שקיעה בים" },
  { src: img7.url, alt: "קובי וקארין · סלפי בירושלים" },
  { src: img2.url, alt: "קובי וקארין · טבעת" },
  { src: img8.url, alt: "קובי וקארין · נשיקה בשקיעה" },
